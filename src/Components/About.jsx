    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">B.Tech Degree </span>From Maharishi Markandeshwar Deemed to be University  <br />Mullana Ambala Haryana.
          ...
          >
            ...
            creative way. I <br />
            creates <span className="font-bold">Software Solution</span> Developing Scalable Applications.<br/>
            <br/>
            ...
            <div className="ui-ux-design w-80 flex gap-3 p-4 rounded-lg" style={{background:`${bgcolor==="white" ? "#FFF4F4" :"black"}`,  border:`${bgcolor==="white" ? "none" :"1px solid #A6A6A6"}`}}>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm"
                 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}
                >
                  Proficient in <span className="font-bold">HTML, CSS, JavaScript</span>, and modern frameworks like <span className="font-bold">React</span>
            ...
            <div className="ui-ux-design w-80 flex gap-3 p-4 rounded-lg" style={{background:`${bgcolor==="white" ? "#EEF5FA" :"black"}`,border:`${bgcolor==="white" ? "none" :"1px solid #A6A6A6"}`}}>
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm"
                 style={{ color: `${bgcolor==="white" ? "#000000" : "#A6A6A6"}`}}
                >
                 Design <span className="font-bold">RESTful APIs</span> that are easy to integrate, ensuring seamless data exchange across platforms. Whether it’s for <span className="font-bold">web services</span>, I have expertise in creating robust and scalable backend solutions using <span className="font-bold">C++, Express.js, Node.js, and MongoDB</span>.
                </p>
              </div>
            </div>
